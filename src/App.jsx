...
import PinkMouse from './components/PinkMouse';

const App = () => {
  const { language } = useContext(LanguageContext); // Obter idioma atual

  return (
    <div className="overflow-x-hidden text-neutral-300 antialiased selection:bg-pink-300 selection:text-cyan-1200 min-h-screen relative">
